namespace VideoScraper {
	...
	public static class XElementExtension {
		...
		public static T SafeAttributeValue<T>(this XElement element, XName attributeName) {
			...
			try {
				if (typeof(T).IsEnum) {
					if (extractedAttribute.Value.In(StringComparison.OrdinalIgnoreCase, Enum.GetNames(typeof(T)))) {
		...
		public static T SafeElementValue<T>(this XElement element, XName elementName) {
			...
			try {
				if (typeof(T).IsEnum) {
					if (extractedElement.Value.In(StringComparison.OrdinalIgnoreCase, Enum.GetNames(typeof(T)))) {
